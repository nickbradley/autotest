...
if [ "${7}" -eq "1" ]; then
  projectUrl="https://${githubApiKey}@github.com/stecler/cpsc210project_${projectNum}.git"
else
  projectUrl="https://${githubApiKey}@github.com/stecler/cpsc210project_${delivToMark}_${projectNum}.git"
fi
...
docker run --cap-add=NET_ADMIN \
           ...
           --env DELIVERABLE_URL="https://${githubApiKey}@github.com/stecler/cpsc210__deliverables.git" \
